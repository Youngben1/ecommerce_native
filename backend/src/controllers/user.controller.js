...
export async function addAddress (req, res) {
    try {
        ...
        await user.save();
        res.status(201).json({message: "Address added sucessfully", address: user.addresses});
...
export async function updateAddress (req, res) {
    try {
        ...
        await user.save();
        res.status(200).json({message: "Address updated sucessfully", address: user.addresses});
...
export async function deleteAddress (req, res) {
    try {
        ...
        await user.save();
        res.status(200).json({message: "Address deleted sucessfully", address: user.addresses});
