                  ...
                  {orders.map((order) => {
                    ...
                    return (
                      <tr key={order._id}>
                        ...
                        <td>
                          <select value={order.status} className="select select-sm" disabled={updateStatusMutation.isPending} onChange={(e) => handleStatusChange(order._id, e.target.value)} >
