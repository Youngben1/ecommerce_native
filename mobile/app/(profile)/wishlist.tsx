...
function WishListScreen() {
  ...
  return (
    <SafeScreen>
        {/* HEADER */}
      <View className="px-6 pb-5 border-b border-surface w-full flex-row items-center">
      ...
      {wishlist.length === 0 ? (
        <View className="flex-1 items-center w-full h-screen-safe justify-center px-6">
        ...
        >
          <View className='px-6 py-4'>
            {wishlist.map((item) =>(
              <TouchableOpacity
                key={item._id}
                className='bg-surface mb-3 rounded-3xl overflow-hidden'
                activeOpacity={0.8}
...
function LoadingUI() {
  return (
    <SafeScreen>
      ...
      <View className="flex-1 w-full h-screen-safe items-center justify-center">
